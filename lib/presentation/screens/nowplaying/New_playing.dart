...
import 'package:myapp/presentation/screens/nowplaying/nowartwork.dart';
import 'package:myapp/presentation/screens/nowplaying/playingcontrollers.dart';
                          ...
                          onSelected: (value) {
                            if (value == 1) {
                              ...
                              if (favdata.isfavorate(
                                ...
                                favdata.add(widget.songsModel[currentIndex]);
                                const add = SnackBar(
                                  backgroundColor:
                        ...
                        child: Row(
                          children: [
                            SizedBox(
                              ...
                              child: Text(
                                widget
                                    .songsModel[currentIndex].displayNameWOExt,
                              ...
                              SizedBox(
                                ...
                                child: Text(
                                  ...
                                  style: const TextStyle(
                                      ...
                                      color:
                                          Color.fromARGB(255, 173, 169, 169)),
                                ),
                              ),
                              Consumer<Favouriteprovider>(
                               ...
                               Expanded(
                                 child: Slider(
                                     ...
                                     onChanged: (value) {
                                        ...
                                        data. changetoseconds(value.toInt());
                                         value = value;
