...
import 'package:myapp/presentation/screens/playlist/Playlistsingle.dart';
              ...
              onPressed: () {
                ...
                if (formKey.currentState!.validate()) {
                  ...
                  if (name.isEmpty) {
                    ...
                    Provider.of<PlaylistProvider>(context,listen: false).editplaylist(playlistname, index);
...
Future<void>  saveButtonPressed(context,) async {
  ...
  final music = Playmodel(name: name, songId: []);
   final PlaylistProvid=Provider.of<PlaylistProvider>(context,listen: false);
  
  if (name.isEmpty) {
    return;
  } 
   if (PlaylistProvid.playlist.contains(name)) {
 ...
 PlaylistProvid.addplaylist(music);
